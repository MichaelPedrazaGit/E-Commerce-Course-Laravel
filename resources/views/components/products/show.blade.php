                            ...
                            <div class="p-5 my-md-4">
                                ...
                                <div class="row align-items-stretch mb-4">
                                    ...
                                    <div class="col-sm-5 pl-sm-0"><a
                                            ...
                                            href="{{ route('carrito.create', ['product' => $product->id]) }}">Add to cart</a>
                                    </div>
                    ...
                    <div class="row m-sm-0">
                        <div class="col-sm-2 p-sm-0 order-2 order-sm-1 mt-2 mt-sm-0">
                            <div class="owl-thumbs d-flex flex-row flex-sm-column" data-slider-id="1">
                                ...
                                <div class="owl-thumb-item flex-fill mb-2"><img class="w-100" src="img/product-detail-4.jpg"
                                        alt="..."></div> --}}
                            </div>
                        </div>
                        <div class="col-sm-10 order-1 order-sm-2">
                            <div class="owl-carousel product-slider" data-slider-id="1">
                                ...
                                <a class="d-block" href="img/product-detail-4.jpg" data-lightbox="product"
                                    ...
                                    <img class="img-fluid" src="img/product-detail-4.jpg" alt="..."></a> --}}
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-sm-5 pr-sm-0">
                            <div
                                ...
                                <div class="quantity">
                                    ...
                                    <input name='productId' class="form-control border-0 shadow-0 p-0" type="hidden" value="{{$product->id}}">
                                    <button class="inc-btn p-0"><i class="fas fa-caret-right"></i></button>
                                </div>
                            </div>
                        </div>
