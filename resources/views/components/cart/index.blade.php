              ...
              <tbody>
                  ...
                  <tr>
                    <th class="pl-0 border-0" scope="row">
                      <div class="media align-items-center"><a class="reset-anchor d-block animsition-link" href="detail.html"><img src="{{$producto['producto']->images[0]->url}}" alt="..." width="70"></a>
                        <div class="media-body ml-3"><strong class="h6"><a class="reset-anchor animsition-link" href="detail.html">{{$producto['producto']->name}}</a></strong></div>
                      </div>
                    </th>
                    <td class="align-middle border-0">
                      <p class="mb-0 small">${{$producto['producto']->price}}</p>
                    </td>
                    <td class="align-middle border-0">
